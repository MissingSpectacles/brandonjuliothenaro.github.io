...
function FreeCodeCamp(props) {
  /*---------( https://gist.github.com/Deftwun/e3756a8b518cbb354425 )---------*/
  return (
    <SvgIcon viewBox="0 0 700.08435 482.89237" {...props}>
      <path
...
const Contact = () => {
  ...
  return (
    <Layout title="Contact">
      ...
      <Box my={4} component="section">
        <header>
          <Text align="center" gutterBottom variant="h2">
            Social Medias
          </Text>
        </header>
        ...
        <Grid container justify="center" spacing={4}>
          <Grid item>
            <Link to={siteMetadata.facebookUrl}>
              <Facebook fontSize="large" role="img" titleAccess="Facebook" />
            </Link>
          </Grid>
          <Grid item>
            <Link to={siteMetadata.freeCodeCampUrl}>
              <FreeCodeCamp
                fontSize="large"
                role="img"
                titleAccess="freeCodeCamp"
              />
            </Link>
          </Grid>
          <Grid item>
            <Link to={siteMetadata.githubUrl}>
              <GitHub fontSize="large" role="img" titleAccess="GitHub" />
            </Link>
          </Grid>
          <Grid item>
            <Link to={siteMetadata.instagramUrl}>
              <Instagram fontSize="large" role="img" titleAccess="Instagram" />
            </Link>
          </Grid>
          <Grid item>
            <Link to={siteMetadata.linkedinUrl}>
              <LinkedIn fontSize="large" role="img" titleAccess="LinkedIn" />
            </Link>
          </Grid>
          <Grid item>
            <Link to={siteMetadata.twitterUrl}>
              <Twitter fontSize="large" role="img" titleAccess="Twitter" />
            </Link>
          </Grid>
        </Grid>
      </Box>
